 ...
 * </ol>
 */
public class WriteRunningNoLockTx extends AbstractWriteTx {

    private static final Logger LOG  = LoggerFactory.getLogger(WriteRunningNoLockTx.class);
    private final List<Change> changes = new ArrayList<>();

    public WriteRunningNoLockTx(final RemoteDeviceId id, final NetconfBaseOps netOps,
